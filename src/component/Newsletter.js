...
const Newsletter = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // EmailJS integration
    emailjs.send('service_w0y4uqi', 'template_m61poqa ', { email }, 'nVMndy3q-jQjrcEiu')
    ...
    <div className="max-w-md mx-auto">
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className="items-center m-auto">
          ...
          <button
            type="submit"
            className=" ml-1 bg-blue-900 text-white rounded-md hover:bg-white  hover:text-blue-900 font-bold py-2 px-4 hover:border-blue-900 focus:shadow-outline"
            >
            Subscribe
          </button>
          </div>
